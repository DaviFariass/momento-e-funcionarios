...
INSERT INTO funcionarios(primeiro_nome,sobrenome,email,telefone,data_contratacao,ocupacao_id,salario,gerente_id,departamento_id) VALUES
 ('Davi','Farias','davi.s.s.farias@hotmail.com','650.444.2734','2023-11-10',6,6900.00,108,10);

-- A administração está sem funcionários. Inclua alguns colegas de turma nesse departamento. 
INSERT INTO funcionarios(primeiro_nome,sobrenome,email,telefone,data_contratacao,ocupacao_id,salario,gerente_id,departamento_id) VALUES
 ('Adryan','Andre','adryan@gmail.com','011.876.3446','2023-10-20',3,3000.00,NULL,1),
 ('Brian','Lima','Brian@gmail.com','011.776.8966','2023-10-30',3,3500.00,NULL,1),
 ('Ashilay','Silva','Ashilay@gmail.com','011.348.1128','2023-11-03',3,4100.00,NULL,1);
...
INSERT INTO funcionarios(primeiro_nome,sobrenome,email,telefone,data_contratacao,ocupacao_id,salario,gerente_id,departamento_id) VALUES 
('Joao','lima','lima@momento.org','515.987.0977','2023-11-19',9,5000.00,3,12),
('Samuel','conceicao','conceicao@momento.org','876.890.9812','2023-11-23',9,5200.00,5,12),
('Daniel','Santos','santos@momento.org','564.986.5674','2023-10-06',20,5000.00,2,12);
